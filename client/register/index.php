...
<head>
    ...
    <title>Registar funcionário | Gestão de Presenças</title>
...
<body>
    ...
    <main class="bg-gray-200 p-1 h-[calc(100vh-100px)]">
        ...
        <section class="bg-white w-1/2 h-[80%] mx-auto mt-5 p-6 rounded-lg">
            <form method="post" action="../../server/src/register.php">
                <table class="w-11/12 mx-auto">
                    ...
                    <tr>
                        ...
                        <td class="p-3">
                            <textarea name="address" required cols="30" rows="5" class="bg-slate-300 px-2 rounded-sm outline-[#6e48aa]"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td class="p-3 text-base font-semibold">
                        ...
                        <td>
                        <input type="date" name="start_date" required class="bg-slate-300 px-2 rounded-sm outline-[#6e48aa]" />
                        </td>
                    </tr>
                </table>
